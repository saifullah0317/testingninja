  ...
  return (
    <>
      ...
      <div
        ...
        class="p-4 bg-spurple-100 fixed w-full"
        role="alert"
      >
        <div class="flex">
          <button
            class="text-swhite bg-spurple-300 font-medium rounded-lg text-md px-3 py-1.5 me-2 text-center inline-flex items-center"
          >
            Save changes
          </button>
          <button
            type="button"
            class="text-gray-800 bg-transparent border border-gray-700 hover:bg-gray-800 hover:text-white focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-md px-3 py-1.5 text-center"
      ...
      <div className="h-screen bg-spurple-100"/>
      <div className="h-screen bg-sgray-100"/>
    </>
  );
}
