      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 ">
          <Link href="/" className="flex items-center ps-2.5 mb-5">
            ...
            <span className="self-center text-xl text-lightpurple font-semibold whitespace-nowrap ">
              testingninja
            </span>
          </Link>
          <ul className="space-y-2 font-medium">
            <li>
              <Link
                ...
                className="flex items-center p-2 text-darkgray rounded-lg  hover:bg-gray-100 hover:text-lightpurple group"
              >
                <svg
                  className="flex-shrink-0 w-5 h-5 text-darkgray transition duration-75 group-hover:text-lightpurple "
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 18 18"
            ...
            <li>
              ...
              >
                ...
                <svg
                  ...
                  height="22"
                  viewBox="0 0 50 50"
                  className="text-darkgray group-hover:text-lightpurple"
                  fill="currentColor"
                >
